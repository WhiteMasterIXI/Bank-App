                ...
                <?php else : ?>
                    <li class="Profile">
                        ...
                        <ul class="Profile__options">
                            ...
                            <?php else : ?>
                                <li class="profile_option"><a href="<?= ROOT_URL ?>Systems/Client/Transactions.php">Transactions</a></li>
                            <?php endif ?>
                            <li class="profile_option"><a href="<?= ROOT_URL ?>Systems/Profile/Statistic.php">Informations</a></li>
